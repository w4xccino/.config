...
Plug 'nvim-telescope/telescope.nvim'    "Agrega funcion de busqueda
Plug 'easymotion/vim-easymotion'        "Permite buscar dentro del texto
Plug 'nvim-lua/popup.nvim'              "requerimiento de telescopoe
Plug 'nvim-lua/plenary.nvim'            "Requerimiento de telescope
Plug 'ryanoasis/vim-devicons'           "Iconitos bonitos
Plug 'lervag/vimtex' 			"latex coc
...
set mouse=v 				"permite la interaccion con el mouse
...
let g:vimtex_view_method = 'zathura'    "default PDF viewer for latex
...
let mapleader=',' 	"mapeando la tecla lider por una coma, con esto se completa los tag con doble coma.
...
" TextEdit might failf hidden is not set.
set hidden   
